...
LOCALES = {
    ...
    "ai_enhance": {
        "en": {
            ...
            "mode_label": "AI mode",
            "mode_choices": ["repair", "background_template", "outfit", "social_photo"],
            ...
            "social_photo_template_label": "Social/resume portrait template (informal only)",
            "social_photo_template_choices": ["resume_clean", "linkedin_professional", "soft_profile"],
            ...
            "social_photo_notice_status": "AI social/resume portrait for informal use only; not an official ID photo",
        ...
        "zh": {
            ...
            "template_choices": ["clean_blue", "clean_white", "clean_gray", "resume_soft", "linkedin_clean"],
            "outfit_template_choices": ["business_suit_black", "business_suit_navy", "white_shirt", "business_casual"],
            "social_photo_template_label": "AI 社交/简历头像，仅非正式用途",
            "social_photo_template_choices": ["resume_clean", "linkedin_professional", "soft_profile"],
            "status_label": "AI 状态",
            ...
            "social_photo_notice_status": "AI 社交/简历头像，仅非正式用途；不作为正式证件照",
        ...
        "ja": {
            ...
            "template_choices": ["clean_blue", "clean_white", "clean_gray", "resume_soft", "linkedin_clean"],
            "outfit_template_choices": ["business_suit_black", "business_suit_navy", "white_shirt", "business_casual"],
            "social_photo_template_label": "SNS/履歴書ポートレート（非公式用途のみ）",
            "social_photo_template_choices": ["resume_clean", "linkedin_professional", "soft_profile"],
            ...
            "social_photo_notice_status": "AI SNS/履歴書ポートレートは非公式用途のみで、正式な証明写真ではありません",
        ...
        "ko": {
            ...
            "template_choices": ["clean_blue", "clean_white", "clean_gray", "resume_soft", "linkedin_clean"],
            "outfit_template_choices": ["business_suit_black", "business_suit_navy", "white_shirt", "business_casual"],
            "social_photo_template_label": "소셜/이력서 프로필 사진(비공식 용도 전용)",
            "social_photo_template_choices": ["resume_clean", "linkedin_professional", "soft_profile"],
            "status_label": "AI 상태",
            ...
            "social_photo_notice_status": "AI 소셜/이력서 프로필 사진은 비공식 용도 전용이며 공식 신분증 사진이 아닙니다",
