        ...
        try:
            ...
            if not identity_guard.passed:
                return self._fallback_output(
                    ...
                    mask_edit=mask_edit,
                    crop_edit=crop_edit,
                    face_protected=face_protected or request.mode in {"repair", "background_template", "social_photo"},
                    color_guard_passed=color_guard_passed,
                    protected_region_delta=protected_region_delta,
            ...
            output.metadata = AIEnhanceMetadata(
                ...
                rate_limited=False,
                usage_logged=False,
                template_name=request.template_name if request.mode in {"background_template", "outfit", "social_photo"} else None,
